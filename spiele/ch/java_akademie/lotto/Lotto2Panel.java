...
public class Lotto2Panel extends JPanel
{
	...
	{
		start.setToolTipText("starten Sie die Anwendung");
		stop.setToolTipText("stoppen Sie die Anwendung");
	...
	private JPanel makeFuss()
	{
		...
		JLabel x = new JLabel("johann mildner, basel ", SwingConstants.RIGHT);
	...
	private JPanel makeEingabeNorth()
	{
		...
		n.add(new JLabel("Tippen Sie Ihre Wunschzahlen ein oder" + " druecken Sie auf ..... "));
		n.add(zufall);
	...
	private void protokoll()
	{
		...
		s = "Anzahl der Ziehungen:" + ed7(zZiehungen) + "  "
				+ ed7((int) (Math.round(zZiehungen / 52.0))) + " Jahre\n" + "          Anzahl 3er:"
