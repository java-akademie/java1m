...
{
	private static String FILE = "temp/FirstPdf.pdf";
	private static Font catFont = new Font(Font.FontFamily.TIMES_ROMAN,
			18, Font.BOLD);
	private static Font redFont = new Font(Font.FontFamily.TIMES_ROMAN,
	...
	// iText allows to add metadata to the PDF which can be viewed in
	// your Adobe
	// Reader
			...
			throws DocumentException
	{
		...
		subCatPart = catPart.addSection(subPara);
		subCatPart
				.add(new Paragraph("This is a very important message"));
