...
public class Lottomat
{
	...
	{
		String uberschrift = String
				.format("Lotto %d aus %d (MAX_GEWINNZAHL sollte auf 45 oder 42 gesetzt werden)",
		...
		while (true)
		{
			...
			{
				System.out
						.printf("%,11d. ziehung - rang %d - Gewinnzahlen [%s] %n",
	...
	private static int[] getTipp()
	{
		...
		for (int i = 0; i < MAX_TIPPS; i++)
		{
			while (true)
			{
				...
				zahl = MyTools.getInteger(
						"bitte einen Tipp abgeben > ", 1,
						MAX_GEWINNZAHL) - 1;
